			...
			messages: [
				{
					role: 'system',
					content:
						'Чи сурагчдад зориулсан тайлбар бичдэг туслах. Зөвхөн Монгол хэлээр, бодлогуудыг өөрөө маш сайн бодож, сурагчид хариултийг нь яагаад буруу болохыг яг 2 богино өгүүлбэрээр, markdown болон жагсаалтгүй хариул. Prompt-ийг бүү давт.',
				},
				{
					role: 'user',
					content: [
